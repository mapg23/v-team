...
function sendSuccessInfo(intentId, status, userId) {
  console.log("sending success info", intentId, status, userId);
...
function SuccessContent() {
  ...
  useEffect(() => {
    ...
    sendSuccessInfo(intentId, status, userId);
    successSent.current = true;
  }, [status, intentId, userId])
  ...
  return (
    <div id="payment-status">
      ...
      <a id="retry-button" href="/">Return to home</a>
    </div>
  );
};
