...
describe("tripService", () => {
    ...
    beforeEach(() => {
        ...
        bikeService = {
            ...
            updateBikePositionData: jest.fn(),
            startBike: jest.fn(),
            stopBike: jest.fn(),
            findBikeInUseByBikeId: jest.fn(),
        };
    ...
    describe("_getDbDate", () => {
        test("getDbDate check that date is created", async () => {
            jest.restoreAllMocks(); //test actual function
    ...
    describe("startTrip", () => {
        test("startTrip throws if wallet is empty", async () => {
            bikeService.updateBikePositionData.mockResolvedValue([
